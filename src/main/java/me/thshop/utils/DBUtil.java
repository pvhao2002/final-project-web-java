	...
	public static SessionFactory getSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL, "jdbc:mysql://us-cdbr-east-06.cleardb.net/heroku_8479446b74a49ed?reconnect=true");
				settings.put(Environment.USER, "bff1ffd4e9ace3");
				settings.put(Environment.PASS, "89d3d94c");
