...
import net.enity.OrderDetail;
import net.enity.Orders;
import net.enity.Product;
 ...
 * @author haodeptrai
 */
@WebServlet(urlPatterns = {"/admin-order-detail", "/admin-add-orderdetail", "/admin-edit-orderdetail", "/admin-delete-orderdetail"})
public class OrderDetailController extends HttpServlet {
	...
	try {
	    ...
	    if (url.contains("add")) {
		List<Product> listProduct = proDao.findAll();
	...
	Integer id = Integer.parseInt(request.getParameter("id"));
	OrderDetail item = dao.getItem(id);
