...
<html>
	...
	<link href="${pageContext.request.contextPath}/view/admin/css/styles.css" rel="stylesheet" />
	<script
	...
	<link
	    ...
	    rel="stylesheet"
	    />
	<link rel="stylesheet" href="${pageContext.request.contextPath}/view/admin/css/admin.css"/>
    </head>
