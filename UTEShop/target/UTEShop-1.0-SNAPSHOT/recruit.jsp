...
<head>
    ...
    <title>UTEShop-Tuyen-dung</title>
            ...
            <div class="col-12">
                <div class="body-tuyendung">
                    ...
                    <div class="tuyendung-info">
                        <h1 class="tieude">NHÂN VIÊN</h1><br/>
                        ...
                        <b>3. THỜI GIAN LÀM VIỆC</b>
                        <ul class="tuyendung-noidung">
                            <li>Hành chinh: <span>Từ 18h30 – 18h00 </span>các ngày trong tuần</li>
                            <li>Tối: <span>Từ 18h00 – 21h30 </span>các ngày trong tuần</li>
                            <li>Nghỉ 3 ngày/tháng</li>
                        </ul>

                        <b>4. ĐỊA ĐIỂM LÀM VIỆC</b>
                        <ul class="tuyendung-noidung">
                            <span>20 Đường số 3 - Linh Trung - Thủ Đức - TPHCM.</span>
                        </ul>
                        ...
                        <b>6. QUYỀN LỢI</b>
                        <ul class="tuyendung-noidung">
                            <li>Thu nhập: <span>8.000.000 - 9.000.000 VNĐ/tháng.</span></li>
                            ...
                            <li>Được đào tạo về chuyên môn và kỹ năng trước khi làm việc.</li>
                        ...
                        <ul class="tuyendung-noidung">
                            <li>Ứng viên điền thông tin theo link:
                                <a href="https://docs.google.com/forms/d/e/1FAIpQLSf_Xea3X956LICyvj4TSeYolpNYvPGKmBfODGoeAykffV6NmA/viewform" target="_blank">
                                    <span>Tuyển dụng</span>
                                </a>
                            </li>
                            <li>Hoặc nộp hồ sơ trực tiếp tại <b>20 đường số 3 - Linh Trung - Thủ Đức - TPHCM.</b></li>
                            <li>Hoặc gửi CV qua email:<b> tranquoctuantqd2002@gmail.com</b></li>
                        </ul>
                    </div>
                </div>
            </div>
