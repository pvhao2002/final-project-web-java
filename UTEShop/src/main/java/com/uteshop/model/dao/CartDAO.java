...
public class CartDAO {
    ...
    public CartDAO(HttpServletRequest request, HttpServletResponse response) {
    ...
    private void forwardToPage(String shopcartjsp, HttpServletRequest request, HttpServletResponse response) {
